 ...
 */
bool hasCellValue(vector<int> grid, int width, vector<pair<int,int>> cells, int value){
 ...
 */
vector<int> computeFrontierCellGrid(vector<int> occupancyGrid, int width, int height){
 ...
 */
vector<frontierRegion> computeFrontierRegions(vector<int> frontierCellGrid, int width, int height){
