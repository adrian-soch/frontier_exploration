...
#       default_value=os.path.join(turtlebot4_navigation_dir, 'config', 'nav2.yaml'),
        default_value=os.path.join(frontier_exploration_dir, 'config', 'nav2.yaml'),
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(frontier_exploration_dir, 'launch',
                                                       'slam_custom.launch.py')),
            condition=LaunchConfigurationEquals('slam', 'custom'),
            launch_arguments={'namespace': namespace,
                              'use_sim_time': use_sim_time}.items()),
